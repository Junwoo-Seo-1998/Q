/*
	File Name: FlameThrowerDyingState.h
	Project Name: Q
	Author(s):
...
class FlameThrowerDyingState : public IEnemyState<FlameThrowerDyingState>
{
public:
	FlameThrowerDyingState() { StateName = "FlameThrowerDyingState"; }
