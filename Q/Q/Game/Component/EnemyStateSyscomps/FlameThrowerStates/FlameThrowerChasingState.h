/*
	File Name: FlameThrowerChasingState.h
	Project Name: Q
	Author(s):
...
class FlameThrowerChasingState : public IEnemyState<FlameThrowerChasingState>
{
public:
	...
	static void OnRayEvent(q_engine::GameState* controlledState, q_engine::IDType enemyID, q_engine::RayTriggerEvent* triggerEvent);
