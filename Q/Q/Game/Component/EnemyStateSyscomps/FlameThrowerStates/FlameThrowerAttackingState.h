/*
	File Name: FlameThrowerAttackingState.h
	Project Name: Q
	Author(s):
...
class FlameThrowerAttackingState : public IEnemyState<FlameThrowerAttackingState>
{
public:
	FlameThrowerAttackingState() { StateName = "EnemyAttackingState"; }
