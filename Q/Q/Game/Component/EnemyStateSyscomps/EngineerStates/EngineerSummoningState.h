/*
	File Name: EngineerSummoningState.h
	Project Name: Q
	Author(s):
...
class EngineerSummoningState : public IEnemyState<EngineerSummoningState>
{
	static void SummonTurret(q_engine::GameState* controlledState, q_engine::IDType enemyID, double dt, glm::vec2 position);
public:
