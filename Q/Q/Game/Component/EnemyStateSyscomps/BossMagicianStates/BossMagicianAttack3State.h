/*
	File Name: BossMagicianAttack3State.h
	Project Name: Q
	Author(s):
...
class BossMagicianAttack3State : public IEnemyState<BossMagicianAttack3State>
{
private:

	static void ShootBullets(q_engine::GameState* controlledState, q_engine::IDType enemyID, float offset);
public:
	BossMagicianAttack3State() { StateName = "BossMagicianAttack1State"; }
