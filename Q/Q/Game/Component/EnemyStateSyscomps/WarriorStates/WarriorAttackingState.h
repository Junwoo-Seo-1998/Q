/*
	File Name: WarriorAttackingState.h
	Project Name: Q
	Author(s):
...
class WarriorAttackingState : public IEnemyState<WarriorAttackingState>
{
public:
	WarriorAttackingState() { StateName = "EnemyAttackingState"; }
