/*
	File Name: ScoutAttackingState.h
	Project Name: Q
	Author(s):
...
class ScoutAttackingState : public IEnemyState<ScoutAttackingState>
{
private:
	static void ShootingBullet(q_engine::GameState* controlledState, q_engine::IDType enemyID);
public:
