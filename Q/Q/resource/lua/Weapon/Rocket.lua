...
function Attack()
    ...
    velo_cani.y=100
    pos.y=pos.y+45
    --Create.ProjectileWithGravity(pos,velo_cani,Vector2.new(4,2),"resource/lua/Projectile/BasicCanister.lua")
    ...
    Create.Projectile(pos,velo,Vector2.new(0.3,0.3),"resource/lua/Projectile/BasicRocket.lua")

    Sound_Component:PlaySoundEffect("rocket-launch", false)
end
