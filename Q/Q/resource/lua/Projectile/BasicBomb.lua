...
function OnInit()
	...
	CurrentScene:AddTagComponent(TypeID.ProjectileEntity,MyID,"Bomb")
	print("BombAddTag")
end
...
function OnCollideWith(typeID,entt_id)
    ...
    if(TypeID.MapEntity==typeID) then
		...
		if(already_create_effect==false) then
            ...
            Create.AnimationWithScript(pos,Vector2.new(1,1),Vector2.new(0.3,0.3),"resource/lua/Simple/SimpleAnimation.lua")
